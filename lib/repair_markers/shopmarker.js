...
function getHtmlFormattedImage(image, mapillary) {
  var result = "";
  if (image) {
    result = "<img src='" + image + "' width='200px' style='width=100%;max-width:100%;height:auto' align='left'/>";
  } else if (mapillary) {
    result = "<img src='https://d1cuyjsrcm0gby.cloudfront.net/" + mapillary + "/thumb-640.jpg' width='200px' style='width=100%;max-width:100%;height:auto'  align='left' />";
  }
  return result;
}
