 ...
 */
function getHtmlFormattedAddress(housenumber, housenumber2, street, street2, postcode, postcode2, city, city2) {
  var address = "";
...
function getHtmlFormattedContribution(elementId) {
  var baseUrl = "https://openstreetmap.org/edit?node=";
