#!/bin/bash
wget -o output.json 'https://www.overpass-api.de/api/interpreter?data=[out:json][timeout:500][maxsize:20737418];((node["charity"="yes"]))'
...
# coords='(40,-8,53,8)'
# url="https://www.overpass-api.de/api/interpreter?data=[out:json][timeout:500][maxsize:20737418];(area[\"ISO3166-1\"=\"FR\"]; )->.fr;(node[\"charity\"][\"charity\"!=\"no\"](area.fr);way[\"charity\"][\"charity\"!=\"no\"](area.fr););out center;"
